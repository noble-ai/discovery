...
<table>
  <tr>
    ...
    <td valign="middle">
      A self-contained Windows app - no SDK, no cloud setup. Current release: <strong>v0.15.11</strong>.<br>
...
| --- | --- | --- | --- |
| v0.15.10 _(previous)_ | 2026-08-10 | Windows x64 | [`Discovery-app-0.15.10-preview-win-x64.exe`](https://aka.ms/discovery/download/previous) |
| v0.15.10 _(previous)_ | 2026-08-10 | Windows Arm64 | [`Discovery-app-0.15.10-preview-win-arm64.exe`](https://aka.ms/discovery/download/arm64/previous) |
